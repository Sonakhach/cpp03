...
ScavTrap::ScavTrap() /* :ClapTrap::m_Hit(100),ClapTrap::m_Energy(50), ClapTrap::m_Attack_damage(20) */ 
{ 
...
{
    std::cout << "this is  assigment operator ScavTrap" << std::endl;
    if (this != &obj)
    {
...
ScavTrap::ScavTrap(const std::string &name):  ClapTrap(name) /* : m_name(name),m_Hit(10),m_Energy(10),m_Attack_damage(0) */
{
    ClapTrap::m_Energy = 50;
    ClapTrap::m_Hit = 100;
    ClapTrap::m_Attack_damage = 20;
